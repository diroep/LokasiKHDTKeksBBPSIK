...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [10544705.821566, -1687872.018177, 15442106.178109, 893680.346723], maxZoom: 28, minZoom: 1
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([10544705.821566, -1687872.018177, 15442106.178109, 893680.346723], map.getSize());
    ...
    element: (() => {
        ...
        if (169 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = '> Klik tanda titik hijau pada peta untuk menampilkan informasi KHDTK; + / - untuk zoom tampilan; ikon penggaris untuk mengukur jarak; ikon pencarian untuk melacak alamat';
            }
